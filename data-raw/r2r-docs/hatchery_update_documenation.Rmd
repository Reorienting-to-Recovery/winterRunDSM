...
winter_hatchery_release = matrix(0, nrow = 31, ncol = 4, dimnames = list(winterRunDSM::watershed_labels, c("s", "m", "l", "xl")))
...
winter_hatchery_release <- rep(list(winter_hatchery_release), 20)
names(winter_hatchery_release) <- c(1:20)
